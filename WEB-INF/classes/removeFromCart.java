...
@WebServlet("/removeFromCart")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class removeFromCart extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      Integer user_id = 0;
      Integer item_id = 0;
      String snack_id = request.getParameter("itemid");
      ...
      try (
         ...
         Statement stmt = conn.createStatement();
            ...
            if(item_name!=null && quantity!=null){
               ...
               sqlStr = "delete from cart where user_id = " + user_id + " and snack_id = " + item_id;
      ...
      //return Item;
      //out.println("<html><body>Removing Item</body></html>");
      out.close();
   }
}